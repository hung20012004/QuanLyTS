                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <form
                                ...
                                <button type="submit" name="action" value="approve" class="btn btn-success mr-2"
                                    onclick="return confirm('Bạn có chắc muốn phê duyệt phiếu bàn giao này?')">Phê
                                    duyệt</button>
                                <button type="submit" name="action" value="reject" class="btn btn-danger"
                                    onclick="return confirm('Bạn có chắc muốn không phê duyệt phiếu bàn giao này?')">Không
                                    phê duyệt</button>
                            </form>
                        </div>
                    </div>
