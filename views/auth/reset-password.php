...
<head>
    ...
    <title>Đặt Lại Mật Khẩu - Quản lý tài sản</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" action="index.php?model=auth&action=reset_password" method="POST">
                                    <input type="hidden" name="token" value="<?= htmlspecialchars($token) ?>">
                                    <div class="form-group">
                                        <input type="password" name="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Nhập mật khẩu mới..." required>
                                    </div>
