...
<?php if (isset($_SESSION['message'])): ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Phê duyệt phiếu trả tài sản</h6>
        </div>
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <strong>Người phê duyệt:</strong> <?= htmlspecialchars($_SESSION['ten']); ?>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-12">
            ...
            <form action="index.php?model=phieutra&action=xet_duyet&id=<?= $phieuTra['phieu_tra_id']; ?>" method="POST" class="mt-4">
