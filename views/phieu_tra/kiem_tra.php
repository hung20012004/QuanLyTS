...
<?php if (isset($_SESSION['message'])): ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Kiểm tra phiếu trả tài sản</h6>
        </div>
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <form action="index.php?model=phieutra&action=kiem_tra&id=<?= $phieuTra['phieu_tra_id']; ?>" method="POST" class="mt-4">
